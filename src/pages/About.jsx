      ...
      <section className="our-story py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg leading-relaxed max-w-3xl mx-auto">
            ...
            indigenous craftsmanship. We have traveled far and wide, connecting
            with skilled artisans and craftsmen who pour their heart and soul
            into every piece they create. Our journey has taken us to remote
            villages and bustling marketplaces, where we have discovered the
            stories and traditions behind each product.
          </p>
        </div>
      </section>
